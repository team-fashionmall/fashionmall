package com.fashionmall.coupon.security.config;

import com.fashionmall.common.jwt.JwtUtil;
import com.fashionmall.common.redis.RedisUtil;
import com.fashionmall.coupon.security.filter.JwtAuthorizationFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) -> authorizeHttpRequests
                ...
                .requestMatchers("/coupon/profile").permitAll()
